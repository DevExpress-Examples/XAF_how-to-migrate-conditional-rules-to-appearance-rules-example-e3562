...
Namespace RuleConversion2.Win
	Partial Public Class RuleConversion2WindowsFormsApplication
		...
		Private Sub RuleConversion2WindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles MyBase.DatabaseVersionMismatch
#If EASYTEST Then
			e.Updater.Update()
			e.Handled = True
#Else
